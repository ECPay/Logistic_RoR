require 'ecpay_logistics'
    ...
    b2candc2c_param = {
      'MerchantTradeNo' => '210127tst1215615156', #請帶20碼uid, ex: f0a0d7e9fae1bb72bc93, 為aiocheckout時所產生的
      'MerchantTradeDate' => '2021/01/27 16:23:45', #請帶交易時間, ex: 2017/05/17 16:23:45, 為aiocheckout時所產生的
      'LogisticsType' => 'CVS',
      ...
      'Remark' => '',
	  'PlatformID' => '',
	  'ReceiverStoreID' => '001328', #請帶收件人門市代號
	  'ReturnStoreID' => ''
    }
